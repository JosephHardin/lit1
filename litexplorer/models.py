...
class docdb(models.Model):
    ...
    author = models.CharField(default=None, max_length=500, null=True, blank=True)
    degree = models.IntegerField(default= None, null=True, blank=True)
    parents = models.CharField(default=None, max_length=500, null=True, blank=True)
    children = models.CharField(default=None, max_length=500, null=True, blank=True)
